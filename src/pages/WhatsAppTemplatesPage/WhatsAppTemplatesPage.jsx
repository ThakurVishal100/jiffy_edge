  ...
  return (
    <div className="bg-gray-100 min-h-screen p-6">
      ...
      <div className="mb-6">
        ...
        <p className="text-sm text-gray-500">Manage message templates for WhatsApp Business API</p>
      </div>
      ...
      <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
        <div className="mb-4">
          ...
          <p className="text-sm text-gray-500">Manage message templates for WhatsApp Business communication</p>
        </div>
          ...
          <table className="w-full text-sm text-left">
            <thead>
              <tr className="border-b">
                ...
                <th className="text-xs text-gray-500 uppercase py-3 px-4">Category</th>
                <th className="text-xs text-gray-500 uppercase py-3 px-4">Status</th>
                <th className="text-xs text-gray-500 uppercase py-3 px-4">Language</th>
                <th className="text-xs text-gray-500 uppercase py-3 px-4">Variables</th>
                <th className="text-xs text-gray-500 uppercase py-3 px-4">Created</th>
                  ...
                  <tr key={template.id} className="border-b last:border-b-0">
                    ...
                    <td className="py-4 px-4">
                      <div className="flex flex-row items-center">
                        {statusStyle.icon}
                        <span className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium text-white ${statusStyle.badgeColor}`}>
                          {template.status}
                        </span>
                      </div>
                    </td>
